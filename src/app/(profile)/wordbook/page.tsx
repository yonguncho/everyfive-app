  ...
  return (
    <div className="max-w-md mx-auto pb-24">
      ...
      {isFree && (
        <a
          href="/subscription"
          className="mx-4 mb-1 flex items-center gap-3 rounded-2xl bg-brand px-4 py-3"
        >
          <span className="text-xl">⭐</span>
          <div className="flex-1">
            <div className="text-sm font-semibold text-white">Pro 전환 시 학습 단어 2배</div>
            <div className="text-xs text-white/70 mt-0.5">하루 10~20단어 · 7일 무료 체험</div>
          </div>
